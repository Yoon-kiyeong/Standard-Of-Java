...
//주로 if문과 함께 사용되어 특정 조건을 만족하는 경우에 continue문 이후의 문장들읖 수행하지 않고 다음 반복으로 넘어가서 계속 진행하도록 한다.
//전체 반복 중에 특정조건을 만족하는 경우를 제외하고자 할 때 유용하다.

//1과 10사이의 숫자를 출력하되 그 중에서 3의 배수인 것은 제외하도록 하였다. i의 값이 3의 배수인 경우, if문의 조건식 'i%3==0'은 참이 되어 continue문에 의해 반복문의 블럭 끝'}'으로 이동된다.
